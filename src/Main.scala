...
package frontside {
  ...
  class DUT(val P: Param) extends Module {
    ...
    u_ilb.vlb_res_o(0) <> ilb_res_o(0)
    u_ilb.vlb_res_o(1) <> ilb_res_o(1)
    ...
    u_dlb.vlb_res_o(0) <> dlb_res_o(0)
    u_dlb.vlb_res_o(1) <> dlb_res_o(1)
